    ...
    <section id="services" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-10">
      <div className="mb-10 flex flex-col justify-between gap-6 md:flex-row md:items-end">
        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
          ...
          <Link
            to="/services"
            className="hidden sm:inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs font-semibold text-slate-700 hover:border-slate-300 hover:text-blue-600 transition shadow-xs whitespace-nowrap"
          >
            <span>View All</span>
      ...
      <div className="mt-12 flex flex-col sm:flex-row items-center justify-between gap-6 rounded-3xl border border-slate-200/80 bg-gradient-to-r from-blue-50/80 via-white to-slate-50 p-6 md:p-8 shadow-xs">
        <div>
          <h4 className="text-base md:text-lg font-bold text-slate-900">
            Looking for more specialized trades or repairs?
          </h4>
          <p className="mt-1 text-xs md:text-sm text-slate-500">
            Browse our complete catalog with advanced filters, duration estimates, and upfront pricing.
          </p>
        </div>

        <Link
          to="/services"
          className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/25 hover:brightness-110 transition flex-shrink-0"
        >
